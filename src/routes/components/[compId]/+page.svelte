	...
	<div class="footer-buttons">
		{#if isEditMode}
			<div class="save-button">
				<button class="save-btn" on:click={handleSaveClick}>Save</button>
			</div>
		{/if}
...
<style>
	...
	.right-box .update-btn:hover {
		box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.3);
	}

	.right-box .hisory-button {
		width: 209px;
		height: 53px;
		border: none;
		border-radius: 5px;
